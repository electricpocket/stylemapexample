...
public class StyledMapDemoActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private int mStyleIds[] = {
            R.string.style_label_no_visibility,
            R.string.style_label_alpha0,
    ...
    public void onMapReady(GoogleMap map) {
        ...
        SupportMapFragment myMapView = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map);
        myMapView.getView().setBackgroundColor(Color.TRANSPARENT);
        //myMapView.getView().setAlpha(0);
        setSelectedStyle();
    }
    ...
    private void setSelectedStyle() {
        ...
        SupportMapFragment myMapView = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map);
        myMapView.getView().setAlpha(1);
        switch (mSelectedStyleId) {
            case R.string.style_label_no_visibility:
                // Sets the retro style via raw resource JSON.
                style = MapStyleOptions.loadRawResourceStyle(this, R.raw.transparent);
                // Sets the retro style via raw resource JSON.
                break;
            case R.string.style_label_alpha0:
                // Sets the retro style via raw resource JSON.
                myMapView.getView().setAlpha(0);
                return;
